...
const PAID_API_ORDER_PATH = 'y/coop/Register/b2bMemberId/ver1.0/p.json';
const PAID_API_CONFIRM_ORDER_PATH = 'y/coop/Fix/b2bCreditId/ver1.0/p.json';
const PAID_API_ALLOW_LOG = true;
const PAID_API_LOG_PATH = '/tmp/paidlib/';
